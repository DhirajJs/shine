...
<div class="form">
    ...
    <div class="dashboard">
        ...
        <a href="patientsHealthData.php" class="button-link">Health Data</a>
        <?php if(isset( $_SESSION['user']) &&  $_SESSION['user']['types']=='D'){?>
        <a href="patientsgraph.php" class="button-link">Progress and Graphs</a>
        <?php } ?>
        <a href="#reminders" class="button-link">Reminders</a>
        <?php  if($isLogin) { ?>
